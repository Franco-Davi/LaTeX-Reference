...
% ----- Desenhos e diagramas -----
	...
	\begin{center}
		\begin{tikzpicture}[scale=2]
			...
			\draw[thick] ({0.5*sin(30)}, {-0.5*cos(30)}) arc (-30:-90:0.25);
			\node at (0.2,-0.65) {$\theta$};
			
			\draw[->, red, thick] ({2*sin(30)}, {-2*cos(30)}) -- ++(0,-1) node[right] {$\vec{P}$};
			\draw[->, blue, thick] ({2*sin(30)}, {-2*cos(30)}) -- ({1*sin(30)},{-1*cos(30)}) node[midway, below left] {$\vec{T}$};
			
			\node at ({2*sin(30) + 0.2}, {-2*cos(30) - 0.2}) {m};
